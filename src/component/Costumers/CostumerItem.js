...
export const CostumerItem = ({ fullName, city, id,status}) => (
                  ...
                  <TableCell className="alignright" >{fullName}</TableCell>
                  <TableCell  className="alignright">{cityRenderer(city, id)} </TableCell>
                  <TableCell  className="aligncenter">
                  {
                 ((Status(status,id))==="فعال")? (<i class="material-icons costumerButtongreen"><tittle class="font-iran-sans">فعال</tittle>record_voice_over</i>)
